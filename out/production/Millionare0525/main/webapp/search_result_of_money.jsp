...
<%@ page import="main.java.com.example.mywebapp.SearchServletOfMoney" %>
...
<div class="content">
    <div class="search-container">
        <form action="search_result_of_money" method="get" style="display: flex; width: 100%;">
            <input type="text" id="query" name="query" required placeholder="Enter anything you want to search in money page">
            <input type="submit" value="Search">
        </form>
    </div>

    <h2>Search Result in Money</h2>

    <div style="display: flex; justify-content: space-between;">
        <button style = "background-color: #4CAF50;color:white; border: #4CAF50;height: 30px" onclick="window.location.href='money.jsp'">Back to money</button>

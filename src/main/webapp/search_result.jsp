...
<div class="content">
    <div class="search-container">
        <form action="search" method="get" style="display: flex; width: 100%;">
            <input type="text" id="query" name="query" required placeholder="Enter anything you want to search">
            <input type="submit" value="Search">
        </form>
    </div>
    <h2>Search Result</h2>
    <button style = "background-color: #4CAF50;color:white; border: #4CAF50;height:30px;width: 180px ;" onclick="window.location.href='search.jsp'">Back to the home page</button>

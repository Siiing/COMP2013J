...
<%@ page import="main.java.com.example.mywebapp.SearchServletOfSource" %>
...
<div class="content">
    ...
    <h2>Search Result in Source</h2>
    <div style="display: flex; justify-content: space-between;">
        <button style = "background-color: #4CAF50;color:white; border: #4CAF50;height: 30px" onclick="window.location.href='source.jsp'">Back to source</button>
    ...
    <table>
        ...
        <tr>
            ...
            <th>Wealth in 2018</th>
            <th>Wealth in 2019</th>
            <th>Wealth in 2020</th>
            <th>Wealth in 2021</th>
            <th>Wealth in 2022</th>
        </tr>
        </thead>

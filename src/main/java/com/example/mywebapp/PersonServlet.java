...
public class PersonServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(type.equals("add")){
            ...
            String newFood = request.getParameter("newFood");
            String newCountry= request.getParameter("newCountry");
            String newSource= request.getParameter("newSource");
            personDAO.updatePersonDetails(Integer.parseInt(pid),null,newFood,newCountry,newSource);
            response.sendRedirect("person.jsp");
        }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(type.equals("del")){
            String pid = request.getParameter("pid");
            resultDAO.deleteResultByPid(Integer.parseInt(pid));
            personDAO.deletePerson(Integer.parseInt(pid));
        }
        response.sendRedirect("person.jsp");
    }
}
